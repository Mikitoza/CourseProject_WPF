...
create table USERTRACKS_ALL(
	id_usertracks_all int identity(1,1) constraint USERTRACKS_ALL_PK primary key,
	id_user int constraint USERTRACKS_ALL_USERTRACKS_FK foreign key references USERTRACKS(usertracks_id),
	tracks_id int constraint USERTRACKS_ALL_TRACKS_FK foreign key references TRACKS(track_id)
)

create table PLAYLIST_ALL(
	id_playlists_all int identity(1,1) constraint PLAYLISTS_ALL_PK primary key,
